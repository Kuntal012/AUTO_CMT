...
$ddir="/home/ahutchison/VLF/raw_data/August10/20100819/hh/zp/" ; # Data directory, added by AG
####
$S2H="$MTIDIR"."perl/bat_sac2helm_ag.pl" ;
$SINV="$MTIDIR"."perl/sub_tdmrf_inv_cmt_ag.pl" ;
$TGMT="$MTIDIR"."perl/tdmrf_gmt_out_ag.pl" ;
####
$fhead=$ARGV[0] ;
