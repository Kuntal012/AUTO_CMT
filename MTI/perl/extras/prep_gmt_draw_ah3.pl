...
$ddir="/home/ahutchison/VLF/out_dir201008/zp/" ; # Data directory, added by AG
####
$S2H="$MTIDIR"."perl/bat_sac2helm_ah.pl" ;
$SINV="$MTIDIR"."perl/sub_tdmrf_inv_cmt_ah.pl" ;
$TGMT="$MTIDIR"."perl/tdmrf_gmt_out_ah.pl" ;
####
$fhead=$ARGV[0] ;
