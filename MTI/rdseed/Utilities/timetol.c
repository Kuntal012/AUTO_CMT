...
if (diff_sec != 0)
{
	printf("secsPerSample = %f\n", secsPerSample);

	printf("samplesPerSec=%6.2f, diff_sec=%f  (secsPerSample=%f)  (secsPerSample/2=%f)\n", 
                samplesPerSec, diff_sec, secsPerSample, secsPerSample/2.0);
