...
/*                 +=======================================+                 */
#define LRECL_DEF	4096		/* default logical record length */
#define PRECL		32768		/* default phys rec length */
#define MAX_BLKT_LENGTH	16384		/* initial space allocation */
#define MAX_DATA_LENGTH	2000000		/* initial space allocation */
...
EXTERN struct type11	type11;		/* type 011 blockette */
...
EXTERN float		*seismic_data;				/* seismic data */
EXTERN float			*seismic_data_ptr;		/* ptr to above */
