...
/*                 +=======================================+                 */
	...
	/* check for D, Q, R and compare to q_flag */
	if (q_flag != 'E')
...
/*                 +=======================================+                 */
	...
	if (!continuous)
	{
		...
		micro_sec = scan_for_blk_1001(input_data_ptr + input_data_hdr->bofb - 8,  /* points to blockettes */
					input_data_ptr - 8);  			  /* points to lrec base 00000D... */
/*                 +=======================================+                 */
